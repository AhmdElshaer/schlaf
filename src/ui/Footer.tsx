...
export default function Footer() {
  return (
    <>
      <div className='footer bg-schlafBlue w-full'>
      <div className='container  mx-auto flex flex-col lg:flex-row gap-5 pt-8 pb-14 px-4 text-white lg:h-[60vh] xl:gap-8 lg:w-full xl:w-[65%] xl:pt-14 xl:px-1 xl:justify-start'>
      ...
      <div className='border-t border-slate-500 py-1 w-full text-xs text-center bg-schlafBlue text-white'>Designed and Developed by Icon</div>
    </>
  )
}
